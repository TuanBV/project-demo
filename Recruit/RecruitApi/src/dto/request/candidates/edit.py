...
class EditCandidateRequest(BaseModel):
  ...
  telephone_no: Optional[str] = Field(None, title="Telephone number", regex=r"^0(\d{10,11})$|^$")
  position_id: Optional[str] = Field(None, title="Position id", regex=r"^\d$", min_length=1)
  team_id: Optional[str] = Field(None, title="Team id", regex=r"^\d$", min_length=1)
  cv_file: Optional[FileItem]
  office_id: Optional[str] = Field(None, title="Office id", regex=r"^\d$", min_length=1)
  recommender_id: Optional[str] = Field(None, title="Recommender id", regex=r"^\d$", min_length=1)
  status: Optional[str] = Field(None, title="Candidate status", regex=r"^\d$")
