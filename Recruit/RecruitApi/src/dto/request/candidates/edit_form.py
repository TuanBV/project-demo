...
class EditFormCandidateRequest(BaseModel):
  ...
  start_join_date: str = Field(None, title="Start join date", regex=r"^(\d{4})\/(0[1-9]|1[0-2])\/(0[1-9]|[1-2][0-9]|3[0-1])$", min_length=1)
  telephone_no: str = Field(None, title="Telephone number", regex=r"^0(\d{9,10})$")
