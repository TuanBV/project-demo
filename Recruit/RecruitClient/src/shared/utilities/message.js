const MESSAGE = {
  ...
  INTERVIEW_SCHEDULE: {
    ADD: {
      ...
      SUCCESS: 'Thêm lịch phỏng vấn thành công',
    },
    UPDATE: {
...
const ERROR = {
  ...
  BIRTHDAY: {
    ...
    INVALID: 'Nhập đúng định dạng ngày sinh yyyy/MM/DD',
  },
  REGISTERED_DATE: {
  ...
  START_JOIN_DATE: {
    IS_FUTURE: 'Ngày đi làm phải là tương lai',
    REQUIRED: 'Ngày đi làm là trường bắt buộc',
  },
  PLACE_OF_BIRTH: {
  ...
  INTERVIEW_DATE: {
    REQUIRED: 'Ngày PV là trường bắt buộc',
    INVALID: 'Ngày PV phải có format là yyyy-mm-dd',
    FUTURE: 'Ngày PV phải là ngày tương lai',
    FAIL_DATE: 'Nhập sai ngày',
  },
  INTERVIEW_TIME: {
    REQUIRED: 'Thời gian PV là trường bắt buộc',
    INVALID: 'Thời gian PV phải có format là HH:MM',
  },
  STATUS: {
  ...
  LINK_INTERVIEW: {
    REQUIRED: 'Link PV là trường bắt buộc',
  },
  MEETING_ROOM: {
