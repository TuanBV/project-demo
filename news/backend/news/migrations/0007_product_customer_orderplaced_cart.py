...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('news', '0006_remove_customer_user_remove_orderplaced_customer_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Andaman', 'Andaman'), ('Andhra Pradesh', 'Andhra Pradesh'), ('Assam', 'Assam'), ('Bihar', 'Bihar'), ('Chandigarh', 'Chandigarh'), ('Daman', 'Daman')], max_length=50)),
