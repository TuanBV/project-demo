...
import AddPageView from 'components/admin/modal/AddPageView.vue'
// 1) ======= INITIALIZATION ========
// 2) ======= VARIABLE REF ========
const users = ref([])
...
<template>
  <div>
    ...
    <div class="mb-2 flex justify-between">
      <h1 class="text-xl tracking-wide">List Url Page</h1>
      <button
      ...
      <table class="w-full table-fixed">
        <thead>
          <tr class="bg-gray-100">
            ...
            <th class="w-5/12 px-6 py-4 text-left font-bold uppercase text-gray-600">Name Page</th>
            <th class="w-4/12 px-6 py-4 text-left font-bold uppercase text-gray-600">Link</th>
    ...
    <div class="overflow-hidden rounded-xl shadow-xl">
      <table class="w-full table-fixed">
        <thead>
          <tr class="bg-gray-100">
            <th class="w-1/12 px-6 py-4 text-left font-bold uppercase text-gray-600">STT</th>
            <th class="w-7/12 px-6 py-4 text-left font-bold uppercase text-gray-600">Subject</th>
