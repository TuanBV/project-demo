...
<template>
  <div class="bg-gray-100">
    <div class="mx-auto max-w-[1300px] py-8">
        ...
        <div class="col-span-4 sm:col-span-4">
          <div class="rounded-lg bg-white p-6 shadow">
            <div class="flex flex-col items-center">
              ...
              <div class="mt-6 flex flex-wrap justify-center gap-4">
                <a href="#" class="rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"
                  >Contact</a
                >
                <a href="#" class="rounded bg-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-400"
                  >Resume</a
                >
              </div>
            </div>
            ...
            <div class="flex flex-col">
              <span class="mb-2 font-bold uppercase tracking-wider text-gray-700">Skills</span>
              <div>
                <div v-for="(item, index) in tab" :key="index" class="mb-2">{{ item.name }}</div>
              </div>
            </div>
          </div>
        </div>
